...
* <a href="https://github.com/Parik27/DragonFF">A plugin for importing and exporting RenderWare \*.dff files and some of the file formats from Grand Theft Auto 3 to San Andreas.</a>
* <a href="https://github.com/Psycrow101/Blender-3D-RW-Anm-plugin">A plugin for importing and exporting some of the versions of the RenderWare \*.anm file format, including the used in CUK's Silent Hill: Origins</a>